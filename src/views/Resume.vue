...
const resumeData = ref({
  ...
  projects: [
    ...
    {
      name: 'DevFlow 开发者工作流工具',
      nameEn: 'DevFlow - Developer Workflow Toolkit',
      period: '2023.08 — 2024.01',
      desc: '面向前端开发者的 Chrome 扩展工具集，集成 API Mock、请求拦截、性能监控、Console 增强等功能。支持自定义规则引擎，可视化配置界面，本地数据持久化。日活用户 1200+。',
      descEn: 'Chrome extension toolkit for frontend developers featuring API mocking, request interception, performance monitoring, and enhanced console. Supports custom rule engine with visual config UI and local persistence. 1200+ DAU.',
      tech: ['Chrome Extension API', 'Vue 3', 'TypeScript', 'IndexedDB', 'Vite', 'Tailwind CSS'],
      link: 'github.com/alexzhang1030/devflow',
    },
    {
      name: 'DataViz Dashboard 数据可视化看板',
      nameEn: 'DataViz - Real-time Analytics Dashboard',
      period: '2023.03 — 2023.07',
      desc: '企业级实时数据可视化看板系统，支持多数据源接入（MySQL、Redis、InfluxDB）。基于 ECharts + WebSocket 实现秒级数据刷新，自定义拖拽式布局编辑器，支持大屏投屏模式。',
      descEn: 'Enterprise real-time data visualization dashboard with multi-source integration (MySQL, Redis, InfluxDB). Built with ECharts + WebSocket for sub-second refresh, drag-and-drop layout editor, and large-screen display mode.',
      tech: ['Vue 3', 'TypeScript', 'ECharts', 'WebSocket', 'Node.js', 'Express', 'MySQL', 'Redis'],
      link: '',
    },
    {
      name: '个人简历网站',
